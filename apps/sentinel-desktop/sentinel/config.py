...
class SentinelSettings:
    ...
    overlay_thinking_min_width: int = _env_int("SENTINEL_OVERLAY_THINKING_MIN_WIDTH", 220)
    overlay_thinking_max_width: int = _env_int("SENTINEL_OVERLAY_THINKING_MAX_WIDTH", 280)
